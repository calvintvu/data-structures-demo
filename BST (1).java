...
public class BST<T> {
	...
	public T getRoot() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("getRoot: Root is null! Can not access.");
		}
		return root.data;
	}
	...
	private int getSize(Node node) {
		if (node == null) {
			...
			int temp1 = getSize(node.left);
			int temp2 = getSize(node.right);
	...
	public T findMin() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("findMin: BST is empty. Can not find min.");
		}
		return findMin(root);
	}
	...
	public T findMax() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("findMax: BST is empty. Can not find max.");
		}
		return findMax(root);
	}
